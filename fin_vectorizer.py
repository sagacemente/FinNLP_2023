# -*- coding: utf-8 -*-
"""Fin_Vectorizer.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1j1EuiTWshRyxhVfs3E3stCwYUCfbKcW-
"""
...
class Vectorizer:
  ...
  def clean_samples(input_data):
    tag_url = tf.strings.regex_replace(input_data,'', '')
    output_data = tf.strings.regex_replace(tag_url,'', '')
    return output_data
  ...
  def __init__(self, train_set):
    ...
    for element in train_set:
      ...
      #print('authorDocument', authorDocument)
      #print('label', label)
      ...
      #print('POST token_list',token_list)
